...
const AuthScreen = () => {
  ...
  return <div className="hero-bg relative">
    ...
    <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <p className="text-lg mb-4">Watch anymore. Cancel anytime.</p>
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
            <div className="flex-1">
                <div className="relative">
                    <img src="/stranger-things-lg.png" alt="stranger img" className= "mt-4"/>
              ...
              <div className="flex-1 md:text-left text-center">
                ...
                <p className="text-lg md:text-xl">Save your favorites easily and always have somwthing to watch  </p>
              </div>
    ...
    <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg md:text-xl">
                Stream unlimited movies and TV shows on your phone, tablets, laptop, and TV. </p>
            </div>
            <div className="flex-1 relative overflow-hidden">
                <img src="/device-pile.png" alt="dev image" className="mt-4 z-20 relative" />
                <video className="absolute top-2 left-1/2 -translate-x-1/2  h-4/6 z-0
                max-w-[63%]"
                playsInline
                autoPlay={true}
                muted
